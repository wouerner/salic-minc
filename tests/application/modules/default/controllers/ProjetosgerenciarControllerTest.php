<?php
/**
 * Projeto_ProjetosgerenciarControllerTest
 *
 * @package
 * @author isaiassm <isaias1113@outlook.com>
 */
class ProjetosgerenciarControllerTest extends MinC_Test_ControllerActionTestCase
{
    ...
    {
        $this->dispatch('/projetosgerenciar?idPronac=' . $this->idPronac);
        $this->assertUrl('default', 'projetosgerenciar', 'index');
    }
}