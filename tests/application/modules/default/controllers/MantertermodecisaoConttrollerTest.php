 ...
 */
class MantertermodecisaoConttrollerTest extends MinC_Test_ControllerActionTestCase
{
    ...
    {
        $this->dispatch('/mantertermodecisao');
        $this->assertUrl('default', 'mantertermodecisao', 'index');
    }
