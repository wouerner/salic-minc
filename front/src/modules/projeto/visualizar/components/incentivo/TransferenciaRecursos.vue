<template>
    <div>
        ...
        <ModalTemplate
            v-if="modalVisible === 'transferencia-recursos'"
            @close="fecharModal();">
            ...
            <template
                ...
                <table>
                    <thead>
                        <tr>
                            <th
                                ...
                                colspan="2">Projeto Transferidor</th>
                            <th
                                style="background-color: #00b0f0; color: #ffffff;"
                                colspan="4">Projeto Recebedor</th>
                        </tr>
                        <tr>
                            <th>Pronac</th>
                    ...
                    <tbody
                        v-for="(informacoesTransferencia, index) in transferenciaRecursos"
                        :key="index">
                        <tr>
