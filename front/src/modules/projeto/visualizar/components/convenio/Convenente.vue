    ...
    <div id="conteudo">
        ...
        <div v-else-if="dadosProponente.dados">
                ...
                <tr>
                    <td v-if="dadosProponente.dados.CNPJCPF">
                        ...
                        <SalicFormatarCpfCnpj
                            v-else
                            :cpf="dadosProponente.dados.CNPJCPF" />
                    </td>
            ...
            <fieldset>
                ...
                <table
                    v-if="dadosProponente.dados.TelefoneComercial
                        || dadosProponente.dados.TelefoneCelular
                    || dadosProponente.dados.TelefoneResidencial"
                    class="tabela">
            ...
            <fieldset>
                ...
                <table
                    v-if="dadosProponente.dados.Email"
                    class="tabela">
                    <tr class="destacar">
                        <td><b>E-mail</b></td>
                    </tr>
            ...
            <fieldset>
                ...
                <table
                    v-if=" dadosProponente.dados.Natureza || dadosProponente.dados.Esfera ||
