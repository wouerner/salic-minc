    ...
    <div>
        ...
        >
            <template
                ...
                <td class="text-xs-right">{{ props.item.qtFisicaExecutada }}</td>
                <td class="text-xs-right">{{ props.item.PerFisica }} %</td>
                ...
                <td class="text-xs-right">{{ props.item.PercFinanceiro }} %</td>
