<template>
    <div id="conteudo">
        ...
        <table class="tabela" v-if="dadosProjeto.DtConvenio">
            ...
            <tr>
                <td align="center">{{DtConvenioPrimeiraVigencia}} &agrave; {{DtConvenioUltimaVigencia}}</td><!-- OBS:período entre essas datas-->
        ...
        <table class="tabela">
            ...
            <tr>
                <td class="right-align"><SalicFormatarValor :valor="dadosProjeto.SolicitadoCusteio" /></td>
                <td class="right-align"><SalicFormatarValor :valor="dadosProjeto.SolicitadoCapital" /></td>
                <td class="right-align"><SalicFormatarValor :valor="dadosProjeto.vlTotalSolicitado" /></td>
            </tr>
        </table>
