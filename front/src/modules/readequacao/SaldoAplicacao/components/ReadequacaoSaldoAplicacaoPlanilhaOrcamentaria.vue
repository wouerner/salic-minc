...
<div
  ...
  <ul class="collapsible no-margin" data-collapsible="expandable">
    <li v-for="(fontes, fonte) of planilhaCompleta">
      <div
	class="collapsible-header active red-text fonte"
	:class="converterStringParaClasseCss(fonte)"
	v-if="isObject(fontes)"
	>
	...
	<span class="badge">
	  ...
	  <li v-for="(produtos, produto) of fontes">
	    <div
	      class="collapsible-header active green-text"
	      style="padding-left: 30px;"
	      :class="converterStringParaClasseCss(produto)"
	      v-if="isObject(produtos)"
	      >
		...
		<SalicFormatarValor
	      ...
	      <ul class="collapsible no-border no-margin" data-collapsible="expandable">
                <li v-for="(etapas, etapa) of produtos">
                  <div
		    class="collapsible-header active orange-text"
		    style="padding-left: 50px;"
		    :class="converterStringParaClasseCss(etapa)"
		    v-if="isObject(etapas)"
		    >
			...
			v-for="(locais, local) of etapas">
			  ...
			  <div class="center-align margin20" v-if="podeIncluirItem()">
			    <a class="waves-effect waves-light btn white-text btn-incluir-novo-item"
				  ...
				  <SalicFormatarValor
				    :valor="row.vlUnitario"
				    :prefixo="prefixoValor"
				    />
				</td>
                                <td class="right-align">
				  <SalicFormatarValor
				    :valor="row.vlAprovado"
				    :prefixo="prefixoValor"
				    />
				</td>
                                <td class="right-align">
				  <SalicFormatarValor
				    :valor="row.vlComprovado"
				    :prefixo="prefixoValor"
				    />
				</td>
  ...
  <div class="card-action">
    ...
    <div
      id="modalEditar"
      class="modal"
      v-if="disponivelParaEdicaoReadequacaoPlanilha"
      >
    ...
    <div
      id="modalIncluir"
      class="modal"
      v-if="disponivelParaAdicaoItensReadequacaoPlanilha"
      >
      <div class="modal-header margin20">
