        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc sanfona">
                ...
                <div style="display: none;">
                    ...
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'planilha-orcamentaria')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Planilha or&ccedil;ament&aacute;ria">Planilha or&ccedil;ament&aacute;ria</a>
                    ...
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'diligencias')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Dilig&ecirc;ncias do projeto">Dilig&ecirc;ncias do projeto</a>
                    <?php if(in_array($this->intFaseProjeto,array('2','3','4'))):?>
                        ...
                        <!--<a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'analise-readequacao')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para An&aacute;lise de readequa&ccedil;&atilde;o">An&aacute;lise de readequa&ccedil;&atilde;o</a>-->
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'dados-bancarios')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Dados banc&aacute;rios">Dados banc&aacute;rios</a>
                    ...
                    <?php if(in_array($this->intFaseProjeto,array('4'))):?>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'relatorio-final')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Relat&oacute;rios final">Relat&oacute;rio final</a>
                    <?php endif;?>
                    <?php if(in_array($this->intFaseProjeto,array('2','3','4'))):?>
                    ...
                    <?php endif;?>
                    <?php if(in_array($this->intFaseProjeto,array('4'))):?>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'prestacao-de-contas')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Presta&ccedil;&atilde;o de Contas">Presta&ccedil;&atilde;o de contas</a>
                    <?php endif;?>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'tramitacao')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Tramita&ccedil;&atilde;o">Tramita&ccedil;&atilde;o</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'providencia-tomada')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Provid&ecirc;ncia tomada">Provid&ecirc;ncia tomada</a>
                </div>
...
<?php endif;?>
                ...
                <?php } ?>
                <!--<a class="no_seta" href='<?php echo $this->url(array('controller' => 'verprojetos', 'action' => 'imprimir-projeto')); ?><?php echo $codPronac;?>' target="_blank" title="Ir Imprimir Projeto">Imprimir Projeto</a>-->
