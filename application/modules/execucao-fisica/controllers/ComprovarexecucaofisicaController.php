...
class ExecucaoFisica_ComprovarexecucaofisicaController extends MinC_Controller_Action_Abstract
{
    private $getCgcCpf = 0;
    ...
    public function cadastrarLocalRealizacaoAction()
    {
        ...
        $redirectUrl = "execucao-fisica/comprovarexecucaofisica/local-de-realizacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac);
...
//
        ...
        try {
            ...
            $redirectUrl = "execucao-fisica/comprovarexecucaofisica/local-de-realizacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac);
            $redirectUrlErroData = "execucao-fisica/comprovarexecucaofisica/manter-local-de-realizacao-final/idpronac/".Seguranca::encrypt($idpronac);
        ...
        try {
            ...
            foreach ($_POST['siPlanoDeDivulgacao'] as $valores) {
                ...
                if (!empty($_FILES['arquivo'.$x[1]]['tmp_name'])) {
                    ...
                    if (!isset($_FILES['arquivo'.$x[1]])) {
                        parent::message("O arquivo n&atilde;o atende os requisitos informados no formul&aacute;rio.", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }

                    if (empty($_FILES['arquivo'.$x[1]]['tmp_name'])) {
                        parent::message("Favor selecionar um arquivo.", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }

                    $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                    if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                        parent::message("Favor selecionar o arquivo de Marca no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }
            ...
            if (!empty($_POST['novoPeca'])) {
                ...
                if (empty($idPeca) || empty($idVeiculo)) {
                    parent::message("N&atilde;o foi poss&iacute;vel cadastrar o novo plano de divulga&ccedil;&atilde;o do Projeto!", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
                ...
                if (count($planos)==0) {
                    if (!empty($_FILES['arquivoNovo']['tmp_name'])) {
                        ...
                        parent::message("Não foi poss&iacute;vel cadastrar o novo Plano de Divulga&ccedil;&atilde;o!", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }
                }
            }

            parent::message("Dados salvos com sucesso!", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "CONFIRM");
        } catch (Exception $e) {
            parent::message("Erro ao salvar os dados.", "execucao-fisica/comprovarexecucaofisica/plano-de-divulgacao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    }
    ...
    public function cadastrarPlanoDistribuicaoAction()
    {
        ...
        try {
            ...
            if (count($produtoBeneficiario)>0) {
                parent::message("J&aacute; foi cadastrado o mesmo agente para este produto!", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
            } else {
                if (!empty($_FILES['arquivo']['tmp_name'])) {
                    ...
                    if (!isset($_FILES['arquivo'])) {
                        parent::message("O arquivo n&atilde;o atende os requisitos informados no formul&aacute;rio.", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }

                    if (empty($_FILES['arquivo']['tmp_name'])) {
                        parent::message("Favor selecionar um arquivo para o novo Plano de Distribui&ccedil;&atilde;o.", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }

                    $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                    if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                        parent::message("Favor selecionar o arquivo de Marca no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                    }
                    ...
                    parent::message("N&atilde;o foi poss&iacute;vel cadastrar os dados do Plano de Distribui&ccedil;&atilde;o!", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
            }

            parent::message("Dados salvos com sucesso!", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "CONFIRM");
        } catch (Exception $e) {
            parent::message("Erro ao salvar os dados.", "execucao-fisica/comprovarexecucaofisica/plano-de-distribuicao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    }
    ...
    public function cadastrarComprovanteExecucaoAction()
    {
        ...
        try {
            if (!empty($_FILES['arquivo']['tmp_name'])) {
                ...
                if (!isset($_FILES['arquivo'])) {
                    parent::message("O arquivo n&atilde;o atende os requisitos informados no formul&aacute;rio.", "execucao-fisica/comprovarexecucaofisica/comprovantes-de-execucao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                if (empty($_FILES['arquivo']['tmp_name'])) {
                    parent::message("Favor selecionar um arquivo.", "execucao-fisica/comprovarexecucaofisica/comprovantes-de-execucao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                    parent::message("Favor selecionar o arquivo de Marca no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/comprovantes-de-execucao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
                ...
                parent::message("N&atilde;o foi poss&iacute;vel cadastrar o Comprovante de Execu&ccedil;&atilde;o!", "execucao-fisica/comprovarexecucaofisica/comprovantes-de-execucao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
            }

            parent::message("Dados salvos com sucesso!", "execucao-fisica/comprovarexecucaofisica/comprovantes-de-execucao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "CONFIRM");
        } catch (Exception $e) {
            parent::message("Erro ao salvar os dados.", "execucao-fisica/comprovarexecucaofisica/comprovantes-de-execucao$linkFinal/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    }
    ...
    public function enviarRelatorioAction()
    {
        ...
        if (count($erros)>0) {
            ...
            $DadosRelatorio->save();
            parent::message("Relat&oacute;rio enviado com sucesso.", "execucao-fisica/comprovarexecucaofisica/relatoriotrimestral/idpronac/".Seguranca::encrypt($idpronac), "CONFIRM");
        }
    }
    ...
    public function cadastrarTrimestralAction()
    {
        ...
        try {
            ...
            parent::message("Dados salvos com sucesso!", "execucao-fisica/comprovarexecucaofisica/etapas-de-trabalho/idpronac/".Seguranca::encrypt($idpronac), "CONFIRM");
        } catch (Exception $e) {
            parent::message("Erro ao salvar os dados.", "execucao-fisica/comprovarexecucaofisica/etapas-de-trabalho/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    }
    ...
    public function visualizarRelatorioTrimestralAction()
    {
        ...
        if (count($DadosRelatorio)==0) {
            parent::message("Relat&oacute;rio n&atilde;o encontrado!", "execucao-fisica/comprovarexecucaofisica/relatoriotrimestral/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    ...
    public function cadastrarAceiteObraAction()
    {
        ...
        try {
            if (!empty($_FILES['arquivo']['tmp_name'])) {
                ...
                if (!isset($_FILES['arquivo'])) {
                    parent::message("O arquivo n&atilde;o atende os requisitos informados no formul&aacute;rio.", "execucao-fisica/comprovarexecucaofisica/aceite-de-obra-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                if (empty($_FILES['arquivo']['tmp_name'])) {
                    parent::message("Favor selecionar um arquivo para o novo Plano de Distribui&ccedil;&atilde;o.", "execucao-fisica/comprovarexecucaofisica/aceite-de-obra-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                    parent::message("Favor selecionar o arquivo de Marca no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/aceite-de-obra-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
            ...
            parent::message("Dados salvos com sucesso!", "execucao-fisica/comprovarexecucaofisica/aceite-de-obra-final/idpronac/".Seguranca::encrypt($idpronac), "CONFIRM");
        } catch (Exception $e) {
            parent::message("Erro ao salvar os dados.", "execucao-fisica/comprovarexecucaofisica/aceite-de-obra-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    }
        ...
        try {
            if (!empty($_FILES['documentoDoacao']['tmp_name'])) {
                ...
                if (!isset($_FILES['documentoDoacao'])) {
                    parent::message("O arquivo n&atilde;o atende os requisitos informados no formul&aacute;rio.", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                if (empty($_FILES['documentoDoacao']['tmp_name'])) {
                    parent::message("Favor selecionar um arquivo para a Doa&ccedil;&atilde;o do Bem M&oacute;vel.", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                    parent::message("Favor selecionar o arquivo de Doa&ccedil;&atilde;o do Bem M&oacute;vel no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
            ...
            if (!empty($_FILES['documentoAceite']['tmp_name'])) {
                ...
                if (empty($_FILES['documentoAceite']['tmp_name'])) {
                    parent::message("Favor selecionar um arquivo para a Aceite do Bem M&oacute;vel.", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                    parent::message("Favor selecionar o arquivo de Aceite do Bem M&oacute;vel no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
            ...
            parent::message("Erro ao salvar os dados.", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
        }
    }
    ...
    public function cadastrarBensImoveisAction()
    {
        ...
        try {
            if (!empty($_FILES['documentoDoacao']['tmp_name'])) {
                ...
                if (empty($_FILES['documentoDoacao']['tmp_name'])) {
                    parent::message("Favor selecionar um arquivo para a Doa&ccedil;&atilde;o do Bem Im&oacute;vel.", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                    parent::message("Favor selecionar o arquivo de Doa&ccedil;&atilde;o do Bem Im&oacute;vel no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
            ...
            if (!empty($_FILES['documentoAceite']['tmp_name'])) {
                ...
                if (empty($_FILES['documentoAceite']['tmp_name'])) {
                    parent::message("Favor selecionar um arquivo para a Aceite do Bem Im&oacute;vel.", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }

                $tipos = array('bmp','gif','jpeg','jpg','png','raw','tif','pdf');
                if (!in_array(strtolower($arquivoExtensao), $tipos)) {
                    parent::message("Favor selecionar o arquivo de Aceite do Bem Im&oacute;vel no formato BMP, GIF, JPEG, JPG, PNG, RAW, TIF ou PDF!", "execucao-fisica/comprovarexecucaofisica/bens-final/idpronac/".Seguranca::encrypt($idpronac), "ERROR");
                }
