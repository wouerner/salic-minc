...
class Readequacao_ObterPlanilhaReadequacaoController extends MinC_Controller_Rest_Abstract
{
    ...
    public function getAction(){
        ...
        if (!$permissao) {
            ...
            $data = $readequacaoService->obterPlanilhaReadequacao($idReadequacao);
        }
