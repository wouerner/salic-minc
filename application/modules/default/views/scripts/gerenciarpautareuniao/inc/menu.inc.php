        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc">
                ...
                ?>
                    ...
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciaradministrativo', 'readequacao' => 'false', 'plenaria' => 'true')); ?>" title="Ir para Plenária -  análise inicial">Plenária - análise inicial</a>
