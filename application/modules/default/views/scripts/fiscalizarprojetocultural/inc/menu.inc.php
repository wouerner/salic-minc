    ...
    <div id="container">
        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc">
                ...
                <a class ="no_seta" href="<?php echo $this->url(array('module'=>'proposta', 'controller' => 'diligenciar', 'action' => 'listardiligenciaanalista')); ?>?idPronac=<?php echo $projeto->IdPRONAC;?>&situacao=E60&tpDiligencia=172" target="_blank" title="Diligenciar">Diligenciar Proponente</a>
