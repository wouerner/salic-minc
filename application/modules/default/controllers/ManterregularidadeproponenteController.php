...
class ManterRegularidadeProponenteController extends MinC_Controller_Action_Abstract {
    ...
    /**
     * query string (variï¿½veis via get)
     */
    private $queryString = '';
    ...
    public function init() {
        ...
        $PermissoesGrupo[] = 109; // Tï¿½cnico de Anï¿½lise
        ...
        $PermissoesGrupo[] = 92;  // Tï¿½cnico de Admissibilidade
        ...
        $PermissoesGrupo[] = 131; // Coordenador de Admissibilidade
        $PermissoesGrupo[] = 140; // Tï¿½cnico de Admissibilidade
