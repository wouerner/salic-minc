...
class ConsultarDadosProjetoController extends MinC_Controller_Action_Abstract
{
    ...
    public function indexAction()
    {
        ...
        try {
            ...
            $projeto = $dbTableProjetos->obterProjetoCompleto(null, ['a.IdPRONAC = ?' => $idPronac])->current();
...
//            $projeto = $tblProjetos->buscarDadosUC75($idPronac);
//
//
...
//            $this->view->idpronac = $idPronac;
//            $this->view->idPronac = $idPronac;
//            $this->view->idprojeto = $projeto[0]->idProjeto;
//            $this->view->codSituacao = $projeto[0]->codSituacao;
//            if ($projeto[0]->codSituacao == 'E12' || $projeto[0]->codSituacao == 'E13' || $projeto[0]->codSituacao == 'E15' || $projeto[0]->codSituacao == 'E50' || $projeto[0]->codSituacao == 'E59' || $projeto[0]->codSituacao == 'E61' || $projeto[0]->codSituacao == 'E62') {
//                $this->view->menuCompExec = 'true';
//            }
//            $this->view->situacaoProjeto = $projeto[0]->codSituacao;
//
...
//
//            $verificarHabilitado = $geral->verificarHabilitado($projeto[0]->CgcCPf);
...
//                $this->view->itensGeral = $tbPreProjeto->buscar(['idPreProjeto = ?' => $idPreProjeto]);
