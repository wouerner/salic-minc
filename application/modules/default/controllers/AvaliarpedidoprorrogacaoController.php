    ...
    public function avaliarProrrogacaoAction()
    {
        ...
        try {
            if (ProrrogacaoModel::DEFERIDO == $this->getRequest()->getParam('analise')) {
                ...
                parent::message("N�o foi encontrada nenhuma an�lise. Favor preencher o campo obrigat�rio!", "avaliarpedidoprorrogacao/detalhar/prorrogacao/{$idProrrogacao}", "ERROR");
            }
            parent::message('Prorroga��o alterada com sucesso!', 'avaliarpedidoprorrogacao', 'CONFIRM');
            ...
            if ($prorrogacaoModel->hasErros()) {
                ...
                parent::message('N�o foi poss�vel realizar seu pedido!', "avaliarpedidoprorrogacao/detalhar/prorrogacao/{$idProrrogacao}", "ERROR");
            }
        }
    }
