...
class Projeto_Model_Situacao extends MinC_Db_Table_Abstract
{
    ...
    public static function obterSituacoesProjetoArquivado() 
    {
        return [
            ...
            self::BOLSA_VIRTUOSE_ARQUIVADO_ANÁLISE_DO_MÉRITO,
            self::BOLSA_VIRTUOSE_ARQUIVADO_ANÁLISE_DOCUMENTAL,
            ...
            self::PROJETO_ARQUIVADO_RECURSOS_TRANSFERIDOS,
            self::PROJETO_ARQUIVADO_RECURSOS_TRANSFERIDOS_FUNARTE,
            self::PROJETO_ARQUIVADO_SOLICITACAO_DE_ARQUIVAMENTO_DE_PROJETO_DE_EDITAL_FNC_FEITA_PELO_PROPONENTE,
            self::PROJETO_ARQUIVADO_SOLICITACAO_DE_ARQUIVAMENTO_DE_PROJETO_DE_INCENTIVO_FISCAL_FEITO_PELO_PROPONENTE,
            self::PROJETO_ARQUIVADO_DECURSO_DE_PRAZO,
            self::PROJETO_ARQUIVADO_NAO_ATENDIMENTO_DOCUMENTAL
        ];
    }
}
