        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc sanfona">
                ...
                <?php if(isset($this->movimentacaoAtual) && $this->movimentacaoAtual == '95'): ?>
                    ...
                    <a class="no_seta" href="<?php echo $this->url(array('module' => 'proposta', 'controller' => 'manterpropostaincentivofiscal', 'action' => 'enviar-proposta-ao-minc')).$codProjeto; ?>" title="Enviar Proposta ao MinC">Enviar Proposta ao MinC</a>
                <?php endif; ?>
