    ...
    public function encaminharAssinaturaAction() {
        try {
            ...
            if (isset($get['IdPRONAC']) && !empty($get['IdPRONAC']) && $get['encaminhar'] == 'true') {
                ...
                parent::message('Projeto encaminhado com sucesso.', '/{$this->moduleName}/index/encaminhar-assinatura', 'CONFIRM');
                ...
                parent::message('Projetos encaminhados com sucesso.', '/{$this->moduleName}/index/encaminhar-assinatura', 'CONFIRM');
            }
