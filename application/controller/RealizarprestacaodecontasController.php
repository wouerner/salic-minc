...
//        exit(var_dump($dados));
    ...
    public function planilhaorcamentariaAction()
    {
        ...
        $idRelatorio = $this->_request->getParam("idRelatorio");
        $this->view->idRelatorio = $this->_request->getParam("idRelatorio");
        #xd($idRelatorio);
    ...
    public function analisarComprovacaoAction()
    {
        ...
        #Alysson - Passando Novos Parametros
        $idRelatorio = $this->_request->getParam("idRelatorio");
        $this->view->idRelatorio = $this->_request->getParam("idRelatorio");
