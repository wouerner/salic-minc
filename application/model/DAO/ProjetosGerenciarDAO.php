...
class ProjetosGerenciarDAO extends Zend_Db_Table {
	...
	/**************************************************************************************************************************
	* Função que ret orna o sql desejado
	* ************************************************************************************************************************/
	...
	/**************************************************************************************************************************
	* Função para buscar os projetos do componente da comissão
	* ************************************************************************************************************************/
	...
	/**************************************************************************************************************************
	* Função para encaminhar o projeto para outro componente da comissão
	* ************************************************************************************************************************/
...
//                die($dados);
	...
	/**************************************************************************************************************************
	* Função para desativar o componente da comissão
	* ************************************************************************************************************************/
	...
	public function desativarComponente($idAgente, $justificativa) {
		...
		foreach ($result as $dado) {
			...
			// Atualiza a situação do projeto para Inativo
			$dados = "Update BDCORPORATIVO.scSAC.tbDistribuicaoProjetoComissao " .
	...
	/**************************************************************************************************************************
	* Função para habilitar o componente da comissão para o balanceamento
	* ************************************************************************************************************************/
	...
	public static function ativarComponente($idAgente, $justificativa, $usucodigo) {
		...
		// Mudar a situação do componente da comissão para inativo 'I'
	...
	/**************************************************************************************************************************
	* Função para fazer o rebalanceamento dos projetos
	* ************************************************************************************************************************/
	...
	public static function balancear($idPronac) {
		...
		// Busca a Ã¡rea e seguimento do projeto       
		...
		if (!isset ($agenteP) && $agenteP == '') {
			...
			//aqui jÃ¡ estÃ¡ buscando o id do agente que tem a menor quantidade de projetos
...
class ProjetosGerenciarDAO extends Zend_Db_Table {
	...
	/**************************************************************************************************************************
	* Funï¿½ï¿½o que ret orna o sql desejado
	* ************************************************************************************************************************/
	public static function retornaSQL($sqlDesejado) {
	...
	/**************************************************************************************************************************
	* Funï¿½ï¿½o para buscar os projetos do componente da comissï¿½o
	* ************************************************************************************************************************/
	...
	/**************************************************************************************************************************
	* Funï¿½ï¿½o para encaminhar o projeto para outro componente da comissï¿½o
	* ************************************************************************************************************************/
...
//                die($dados);
	...
	/**************************************************************************************************************************
	* Funï¿½ï¿½o para desativar o componente da comissï¿½o
	* ************************************************************************************************************************/
	...
	public function desativarComponente($idAgente, $justificativa) {
		...
		foreach ($result as $dado) {
			...
			// Atualiza a situaï¿½ï¿½o do projeto para Inativo
			$dados = "Update BDCORPORATIVO.scSAC.tbDistribuicaoProjetoComissao " .
			"Set stDistribuicao = 'I',  dsJustificativa='" . $justificativa . "'" .
			"Where idAgente =" . $idAgente . " AND idPronac=" . $dado->idPRONAC . " AND dtDistribuicao='" . $dado->Data . "'";
	...
	/**************************************************************************************************************************
	* Funï¿½ï¿½o para habilitar o componente da comissï¿½o para o balanceamento
	* ************************************************************************************************************************/
	...
	public static function ativarComponente($idAgente, $justificativa, $usucodigo) {
		...
		// Mudar a situaï¿½ï¿½o do componente da comissï¿½o para inativo 'I'
		$dadosUpdateSituacao = array (
			'stConselheiro' => 'A'
		);
		$whereUpdateSituacao = "idAgente =" . $idAgente;
	...
	/**************************************************************************************************************************
	* Funï¿½ï¿½o para fazer o rebalanceamento dos projetos
	* ************************************************************************************************************************/
