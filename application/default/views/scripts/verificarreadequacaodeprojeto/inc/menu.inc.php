...
<div id="menuContexto" style="margin-bottom: 15px;">
    ...
    <div id="qm0" class="qmmc">
    	<a class="no_seta last" onclick="redirecionar('<?php echo $this->url(array('controller' => 'diligenciar', 'action' => 'listardiligenciaanalista')); ?>?idPronac=<?php echo $this->dados[0]->IdPRONAC; ?>&tpDiligencia=171&situacao=<?php echo $this->verificarSituacaoProjeto($this->dados[0]->IdPRONAC); ?>');" href="#" title="Ir para Projetos Diligenciados">Diligenciar</a>
    </div>
