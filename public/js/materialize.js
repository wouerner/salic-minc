...
if ("undefined" == typeof jQuery) {
    var jQuery;
    jQuery = "function" == typeof require ? $jq3 = require("jquery") : $jq3
}
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        var v = t.CSS = {
            ...
            Names: {
                camelCase: function (a) {
                    ...
                    return (n || t.State.isAndroid && !t.State.isChrome) && (b += "|transform"), new RegExp("^(" + b + ")$jq3", "i").test(a)
            ...
            Values: {
                hexToRgb: function (a) {
                    ...
                    a.classList ? a.classList.remove(b) : a.className = a.className.toString().replace(new RegExp("(^|\\s)" + b.split(" ").join("|") + "(\\s|$jq3)", "gi"), " ")
                }
            },
                ...
                function a(a) {
                    ...
                    if ("scroll" === C) {
                        ...
                        g(f).tweensContainer && g(f).isAnimating === !0 && (F = g(f).tweensContainer), m.each(q, function (a, b) {
                            if (RegExp("^" + v.Lists.colors.join("$jq3|^") + "$jq3").test(a)) {
    ...
    var b = $jq3(a), c = b.add(b.parents()), d = !1;
    return c.each(function () {
        return "fixed" === $jq3(this).css("position") ? (d = !0, !1) : void 0
    }), d
};
var Vel;
Vel = jQuery ? jQuery.Velocity : $jq3 ? $jq3.Velocity : Velocity, function (a) {
