...
-- Descrição: Montar planilha orçamentária
-- Data de Alteraão: 15/10/2013
-- =========================================================================================
-- Motivo : incluir a planilha da proposta
-- Data de Alteraão: 24/01/2014
-- =========================================================================================
-- Motivo : incluir o tipo 5 para remanejamento de até 20%.
-- Data de Alteração: 07/02/2014
-- Motivo : Inclusão do atributo valor comprovado nas planilha tipo 3 e 5.
-- =========================================================================================
-- Data de Alteração: 06/03/2014
-- Motivo : Inclusão da planilha do tipo 6 para remanejamento acima de 20%,
--          complementação e redução.
-- =========================================================================================
-- Data de Alteração: 29/04/2014
-- Motivo : Alteração na planilha tipo 4 - WHERE
-- =========================================================================================
-- Data de Alteração: 29/06/2015
-- Motivo : Alteração na query das planilhas tipo 5 e 6
-- =========================================================================================
-- Data de Alteração: 14/06/2015
-- Motivo : Alteração na query das planilhas tipo 6
-- =========================================================================================
-- Data de Alteração: 02/10/2015
-- Motivo : Alteração na query das planilhas - mostrar somente stAtivo = 'S' e permitir que
--          proponente veja a planilha durante a sua construção, após o envio volta novamen-
--          te visualizar a planilha ativa.
-- =========================================================================================
-- Data de Alteração: 15/01/2016
-- Motivo : Alteração na query das planilhas tipo 5
-- =========================================================================================
-- Data de Alteração: 22/01/2016
-- Motivo : Alteração na query das planilhas tipo 6
-- =========================================================================================
-- Data de Alteração: 17/02/2016
-- Motivo : Alteração na query das planilhas tipo 5 e 6 - 
--          Alterado o valor comprovado.
-- =========================================================================================
-- Data de Alteração: 19/05/2016
-- Motivo : Inclusão de restrição na planilha tipo 6 ativa, não mostrar registros excluídos.
-- =========================================================================================
-- Data de Alteração: 18/01/2017
-- Motivo : Inclusão de restrição na planilha tipo 5 ativa, não mostrar registros excluídos.
-- =========================================================================================
-- Data de Alteração: 12/07/2017
-- Motivo : Ajuste para identificar a planilha aprovada segundo a IN_2017
-- =========================================================================================
...
-- =========================================================================================
IF @TipoPlanilha = '3' AND (SELECT sac.dbo.fnVerificar_Projeto_Aprovado_IN2017(@idPronac)) = 1
   BEGIN 
     IF NOT EXISTS(SELECT TOP 1 IdPRONAC FROM sac.dbo.tbPlanilhaAprovacao 
